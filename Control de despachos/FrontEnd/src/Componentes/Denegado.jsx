...
import imagen from '../img/acceso-denegado.png'
                            ...
                            <div className="card my-4">
                                <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                        <h6 className="text-white text-capitalize ps-3">ACCESO DENEGADO</h6>
                                    </div>
                                </div>

                                <div className="row" style={{paddingTop: "50px", paddingBottom: "30px", margin: "auto"}}>
                                    <div className="col-10" style={{fontSize: "100px", fontWeight: 'bold'}}>ACCESO DENEGADO</div>
                                    <div className="col-2" ><img src={imagen} alt="" width={'200px'} height={'200px'} /></div>
                                </div>
                            </div>
                        </div>
                    </div>
